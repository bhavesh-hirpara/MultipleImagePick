 ...
 */
public class ScannerCodeAdapter extends RecyclerView.Adapter<ScannerCodeAdapter.MyViewHolder> {
...
//    private ArrayList<BaseActivity.MenuItem> data = new ArrayList<BaseActivity.MenuItem>();
    ...
    public ScannerCodeAdapter(Context c) {
        this.context = c;
...
//    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.item_scanner_code, parent, false);
...
//            if (0 % 2 != 0){
//                holder.container.setBackgroundColor(context.getResources().getColor(R.color.gr));
//            }
//        }
