 ...
 */
public class FindEventAdapter extends RecyclerView.Adapter<FindEventAdapter.MyViewHolder> {
...
//    private ArrayList<BaseActivity.MenuItem> data = new ArrayList<BaseActivity.MenuItem>();
    ...
    public FindEventAdapter(Context c) {
        this.context = c;
...
//    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.item_find_events, parent, false);
