 ...
 */
public class SoldTicketAdapter extends RecyclerView.Adapter<SoldTicketAdapter.MyViewHolder> {
...
//    private ArrayList<BaseActivity.MenuItem> data = new ArrayList<BaseActivity.MenuItem>();
    ...
    public SoldTicketAdapter(Context c) {
        this.context = c;
...
//    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.item_sold_ticket, parent, false);
