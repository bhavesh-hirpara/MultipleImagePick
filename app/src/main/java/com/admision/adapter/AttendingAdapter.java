 ...
 */
public class AttendingAdapter extends RecyclerView.Adapter<AttendingAdapter.MyViewHolder> {
...
//    private ArrayList<BaseActivity.MenuItem> data = new ArrayList<BaseActivity.MenuItem>();
    ...
    public AttendingAdapter(Context c) {
        this.context = c;
...
//    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.item_attending, parent, false);
